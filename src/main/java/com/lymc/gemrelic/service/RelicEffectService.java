...
public class RelicEffectService {
    ...
    public RelicEffectService(GemRelicPlugin plugin) { this.plugin = plugin; }
    ...
    public void refresh(Player player, PlayerRelicProfile profile) {
        ...
        // 聚合词条并尝试下发AP
        Map<com.lymc.gemrelic.relic.RelicStatType, Double> statSum = plugin.getStatAggregationService().aggregate(profile);
